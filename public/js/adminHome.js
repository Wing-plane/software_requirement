$(document).ready(function ()
{
	...
	}).each(function (index, element)//鼠标选择后导航栏的变化
	{
		$(element).click(function ()
		{
			$(".options li:not(element)").css({"border": "none", "background-color": "inherit"});
			$(element).css({
				"background-color": "#0369b3", "border-left": "solid 1px #d1d1d8",
	...
	{
		$.post("/queryRecord", function (data)
		{
			$("#subHtml").html(data)
				.ready(function ()
				{
	...
	{
		//alert('product');
		$.post("/queryProduct", function (data)
		{
			$("#subHtml").html(data)
				.ready(function ()
				{
